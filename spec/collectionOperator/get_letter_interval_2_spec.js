...
let get_letter_interval = require('../../main/collectionOperator/get_letter_interval_2.js');
...
describe('get_letter_interval', function () {
  ...
  let collection_b = ['ba', 'az', 'ay', 'ax', 'aw', 'av', 'au', 'at',
  ...
  it('根据给出的两个数字得到对应自增的字母区间', function() {
    ...
    let result = get_letter_interval(20, 53);
    expect(result).toEqual(collection_a);
  });

  it('根据给出的两个数字得到对应自减的字母区间', function() {

    let result = get_letter_interval(53, 20);
    expect(result).toEqual(collection_b);
  });

  it('给定两个相同的数字得到只含此数字对应字母的数组', function() {

    let result = get_letter_interval(28, 28);
